...
namespace Pole
{
    public class GameController : MonoBehaviour
    {
        ...
        [SerializeField] private RotateScreen _rotateScreen;
        ...
        {
            _rotateScreen.ScreenClosed += EnableScreen;

            _player.HitWall += EndGame;
        ...
        private void StartNewGame()
        {
            ...
            StartIncreaseScore();
            _wallSpawner.StartSpawning();
            _endGameScreen.DisableScreen();
            _newRecordScreen.DisableScreen();
            _inputDetector.StartDetectingInput();
        }
        ...
        {
            StopIncreaseScore();
            _wallSpawner.StopSpawning();
            _wallSpawner.ReturnAllObjectsToPool();
            _inputDetector.StopDetectingInput();
        }
